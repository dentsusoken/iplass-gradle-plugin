...
For details such as use cases, please refer to the https://github.com/dentsusoken/iPLAss-docs/blob/main/developerguide/src/docs/asciidoc/gradleplugin/index.adoc[official documentation].
...
----
plugins {
  id 'org.iplass.dev' version '1.1.1'
}
----
